      ...
      <div className="skills-right">
        <div className="skills-content-wrapper">
          ...
          <div ref={slide1Ref} className="skills-slide">
            ...
            {/* CRITICAL FIX: 
                1. overflow: 'hidden' -> Cuts off the logos so they don't touch the Dragon
                2. width: '100%' -> Ensures it stays inside the text column
            */}
            <div style={{ 
              marginTop: '2rem', 
              height: '80px', 
              ...
              <LogoLoop
                logos={techLogos}
                speed={80} 
                direction="right" // Changed to RIGHT (Left -> Right motion)
                logoHeight={45} 
                gap={50} 
                hoverSpeed={0} 
                fadeOut={true}
          ...
          <div ref={slide2Ref} className="skills-slide">
            ...
            <h2 className="skills-heading" style={{fontSize: '2.5rem'}}>FULL STACK ENGINEER</h2>
          ...
          <div ref={slide3Ref} className="skills-slide">
            ...
            <h2 className="skills-heading" style={{fontSize: '2.5rem'}}>DATA SCIENTIST</h2>
            <div className="tech-grid">
              {['Python', 'NumPy', 'Pandas', 'Seaborn', 'Matplotlib', 'EDA','sikit-learn', 'TensorFlow', 'PyTorch', 'Keras', 'Machine Learning', 'Deep Learning'].map(tech => (
                <span key={tech} className="tech-pill">{tech}</span>
              ))}
            </div>
          </div>
